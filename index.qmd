...
<table class= "table1-style">
    ...
    <tr>  
        ...
        <th >  {inttoday(-2)}</th>
        <th >  Hier</th>
        <th style="border-top:2px solid rgb(65, 220, 119,0.5);border-right:2px solid rgb(65, 220, 119,0.5);border-left:2px solid rgb(65, 220, 119,0.5)">  Aujourd'hui</th>
        <th >  Demain</th>
        <th >  {inttoday(2)}</th>
        <th >  {inttoday(3)}</th>
        <th >  {inttoday(4)}</th>
  ...
  height="50" /> </td>
        <td style="border-right:2px solid rgb(65, 220, 119,0.5);border-left:2px solid rgb(65, 220, 119,0.5)"> <img src={imgcodeday(2)} width="50"
  height="50" /> </td>
  ...
  height="50" /> </td>
    ...
    <tr> 
        ...
        <td style =" background-color : {couleur(maxtemp[2])};font-weight: bold;border-right:2px solid rgb(65, 220, 119,0.5);border-left:2px solid rgb(65, 220, 119,0.5)" > {maxtemp[2]}°C </td>
    ...
    <tr> 
        ...
        <td style =" background-color : {couleur(mintemp[2])};font-weight: bold;border-right:2px solid rgb(65, 220, 119,0.5);border-left:2px solid rgb(65, 220, 119,0.5)" > {mintemp[2]}°C </td>
    ...
    <tr> 
        ...
        <td style="border-right:2px solid rgb(65, 220, 119,0.5);border-left:2px solid rgb(65, 220, 119,0.5)"> {maxvent[2]}km/h </td>
    ...
    <tr> 
        ...
        <td> {sumpluie[0]}mm </td>
        <td> {sumpluie[1]}mm </td>
        <td style="border-bottom:2px solid rgb(65, 220, 119,0.5);border-right:2px solid rgb(65, 220, 119,0.5);border-left:2px solid rgb(65, 220, 119,0.5)"> {sumpluie[2]}mm </td>
        <td> {sumpluie[3]}mm </td>
        <td> {sumpluie[4]}mm </td>
        <td> {sumpluie[5]}mm </td>
        <td> {sumpluie[6]}mm </td>
