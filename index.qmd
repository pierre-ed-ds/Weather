...
<table class= "table1-style">
    ...
    <tr>  
        ...
        <th>  {inttoday(-2)}</th>
        <th>  Hier</th>
        <th style="border-top:3px solid rgb(85, 215, 195,0.5);border-right:3px solid rgb(85, 215, 195,0.5);border-left:3px solid rgb(85, 215, 195,0.5)">  Aujourd'hui</th>
        <th>  Demain</th>
        <th>  {inttoday(2)}</th>
        <th>  {inttoday(3)}</th>
        <th  style="border-top-right-radius : 20px 20px" >  {inttoday(4)}</th>
    </tr>
    </thead>
    <tbody>
    <tr> 
