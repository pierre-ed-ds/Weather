...
url = f"https://api.open-meteo.com/v1/meteofrance?latitude=52.52&longitude=13.41&hourly=temperature_2m,relativehumidity_2m,apparent_temperature,precipitation,rain,snowfall,weathercode,cloudcover,windspeed_10m,windspeed_20m,temperature_20m&timezone=Europe%2FLondon&forecast_days=1"
...
<table class= "table1-style">
  ...
  height="50" /> </td>
    ...
    <tr> 
        ...
        <td> {pluie[21]}mm </td>
        <td> {pluie[22]}mm </td>
        <td style="border-bottom-right-radius : 20px 20px"> {pluie[23]}mm </td>
    </tr>
    </tbody>
